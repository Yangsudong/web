...
<form method="post" name="frm" id="frm"
	...
	<div>
		<label>id</label><input type="text" name="id" value ="<%=member.getId()%>"><br>
		<label>pass</label><input type="password" name="pass" value ="<%=member.getPass()%>">
	</div>			
	<div>
		<label> 성별</label> 
		<input type="radio" name="gender" value=man 
		<%if("man".equals(member.getGender()) ){out.print("checked='checked'");} %>>남자 
    	<input type="radio" name="gender" value=woman
    	<%if("woman".equals(member.getGender()) ){out.print("checked='checked'");} %>>여자 
    </div><br>
	...
	<div>
		...
		<select name="job" id="job">
			...
			<option value="devlope" 
			<%if("devlope".equals(member.getJob()) ){out.print("selected='selected'");} %>>개발자</option>
			<option value="dba"
			<%if("dba".equals(member.getJob()) ){out.print("selected='selected'");} %>>관리자</option>
			<option value="doctor"
	...
	<div>
		...
		<%if("y".equals(member.getMailYN()) ){out.print("checked='checked'");} %>>동의
